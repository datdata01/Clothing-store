    ...
    <div class="row headermain">
        <div class="col-3">
            <div class="row">
                ...
                <div class="col-4">
                    <img src="./image/logo-removebg-preview.png" height="130px" width=" 130px" alt="">
                </div>
                <div class="col-4"></div>
            </div>
                ...
                <div class="col-4">
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <a style="text-decoration: none;" href="?act=giohang">Giỏ hàng</a>
                        </div>
